 ...
 * Open http://localhost:8080/home.jsf and http://localhost:8080/bye/home.jsf
 */
public class Application {
    ...
    private static void addWebapp(Tomcat tomcat) {
        ...
        System.out.println("Configuring app with basedir: " + absolutePath("./" + WEBAPP_LOCATION));
